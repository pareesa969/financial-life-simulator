...
document.getElementById("savingRatio").innerText=((savings/(savings+debt+1))*100).toFixed(1)+"%"
document.getElementById("debtRatio").innerText=((debt/(savings+debt+1))*100).toFixed(1)+"%"
document.getElementById("investGrowth").innerText="$"+investments
}

function getTitle(){
if(investments>savings && investments>debt) return "The Investor"
if(debt>savings) return "The Risk Taker"
if(savings>investments) return "The Saver"
return "The Spender"
}
...
document.getElementById("playerTitle").innerText="You are: "+getTitle()
